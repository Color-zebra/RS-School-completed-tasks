/* console.log(`
  ...
  ВНИМАНИЕ! На странице our-pets интерактивность при наведении - изменение цвета текста с черного на чуть более черный. Это не заметно, но так указано в макете. \n
  ВНИМАНИЕ! По условию задания ссылки должны быть интерактивны. Логотип является ссылкой, но не имеет стилей для интерактивности в макете. Увеличение при наведении добавлено на усмотрение студента и не противоречит условиям задания \n \n \n
  Страница Main (60) \n
